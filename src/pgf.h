...
int load_pgf_pgscn(int scn_number, int show_info, int probe_file_only);
int load_pgf_equipment(int, char *);
...
void draw_units_bmp(BITMAP *,int);
void draw_units_per_country_bmp(int country, int month, int year);
void draw_one_unit_bmp(BITMAP *, int ,int );
